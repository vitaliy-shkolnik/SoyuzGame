...
public class ScreenClass {
  ...
  public SimpleAnimation createScreenOne(int moveImageX, int moveImageY) {
    ...
    Shape rectangle = new Rectangle(300,300,255,0,0, 125, 125,0);
    Event event0 = new Event(ShapeAttribute.POSITION_X, 10, 30, 700,
            900, true, 1, 0, 0);
    Event event1 = new Event(ShapeAttribute.POSITION_Y, 30, 60, 700,
            900, true, 0, 0, 0);
    Event event2 = new Event(ShapeAttribute.POSITION_Y, 60, 90, 900,
            700, true, 0, 0, 0);
    Event event3 = new Event(ShapeAttribute.POSITION_X, 90, 120, 900,
            700, true, 0, 1, 0);
