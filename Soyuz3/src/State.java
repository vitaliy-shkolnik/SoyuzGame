...
public class State {
  ...
  public State(double posX, double posY, double red,
               double green, double blue, double width, double height, double direction) {
    if (width < 0 || height < 0) {
    ...
    this.attributes.put(ShapeAttribute.DIRECTION, direction);
  }
  ...
  public String toString() {
    return String.format("POSITION_X: %.1f, POSITION_Y: %.1f, RED: %.1f, GREEN: %.1f, "
            ...
            this.attributes.get(ShapeAttribute.DIRECTION));
  }
}
