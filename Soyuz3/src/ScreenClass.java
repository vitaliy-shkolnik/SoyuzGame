...
public class ScreenClass {
  ...
  public SimpleAnimation createScreenOne(int moveImageX, int moveImageY) {
    ...
    Shape rectangle = new Rectangle(400,400,255,0,0, 125, 125,0);



    Shape rectangle2 = new Rectangle(1000,1000,0,255,0, 125, 125,0);
    Event event4 = new Event(ShapeAttribute.POSITION_X, 0, 50, 500,
            325, false, 1, 1, 0);
    Event event5 = new Event(ShapeAttribute.POSITION_Y, 0, 50, 500,
            325, false, 1, 1, 0);

    Shape rectangle3 = new Rectangle(2500,400,0,255,0, 125, 125,0);
    Event event0 = new Event(ShapeAttribute.POSITION_X, 10, 30, 2500,
            2600, true, 1, 0, 0);
    Event event1 = new Event(ShapeAttribute.POSITION_Y, 30, 60, 400,
            500, true, 0, 0, 0);
    Event event2 = new Event(ShapeAttribute.POSITION_Y, 60, 90, 500,
            400, true, 0, 0, 0);
    Event event3 = new Event(ShapeAttribute.POSITION_X, 90, 120, 2600,
            2500, true, 0, 1, 0);
     rectangle3.addEvent(event0);
    rectangle3.addEvent(event1);
    rectangle3.addEvent(event2);
    rectangle3.addEvent(event3);
    Shape rectangle4 = new Rectangle(2300,400,255,0,0, 125, 125,0);
    Shape oval = new Oval(2500,800,255,255,0, 125, 125,0);
    ...
    shapeCollection.addShape(rectangle2);
    shapeCollection.addShape(rectangle3);
    shapeCollection.addShape(rectangle4);
  ...
  public SimpleAnimation createScreenFive() {
    SimpleAnimation shapeCollection = new SimpleAnimationImpl();
    ...
    Shape borderLeft = new Rectangle(0, 0, 255, 0, 0, 5, 600,0);
    Shape borderBottom = new Rectangle(0, 595, 255, 0, 0, 600, 5,0);
    Shape door = new Rectangle(400, 400, 0, 125, 200, 50, 100,0);

    Shape rectangle = new Rectangle(125,125,125,255,40, 125, 125,0);

    Event event0 = new Event(ShapeAttribute.POSITION_X, 0, 50, 125,
            325, true, 1, 0, 0);
    Event event1 = new Event(ShapeAttribute.POSITION_Y, 0, 50, 125,
            325, true, 0, 1, 0);
